...
export default function FaceD() {
  ...
  const handleResponseGeneration = () => {
    Swal.fire({
      title: 'Generating Facebook Content',
  ...
  return (
    <AnimatedPage>
      <div className="mx-auto max-w-lg">
        <h1 className="text-4xl text-center mb-4">Facebook Content Generator</h1>
        <div className="mb-4">
          <Label htmlFor="description" className="mb-2">Facebook Post Description</Label>

...
export default function LinkD() {
  ...
  const handleResponseGeneration = () => {
    Swal.fire({
      title: 'Generating LinkedIn Content',
  ...
  return (
    <AnimatedPage>
      <div className="mx-auto max-w-lg">
        <h1 className="text-4xl text-center mb-4">LinkedIn Content Generator</h1>
        <div className="mb-4">
          <Label htmlFor="description" className="mb-2">LinkedIn Post Description</Label>
